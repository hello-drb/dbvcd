      ...
      <div className="max-w-3xl mx-auto text-center">
        <div className="h-48 sm:h-64 flex items-center justify-center">
          <AnimatePresence mode="wait">
            ...
            >
              <blockquote>
                <p className="text-2xl sm:text-3xl md:text-4xl font-serif font-light leading-tight text-neutral-50">
                  "{testimonials[currentIndex].quote}"
                </p>
              </blockquote>

              <p className="text-neutral-500 font-light tracking-wide text-sm uppercase">
