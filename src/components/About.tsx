...
export default function About() {
  return (
    <section id="about" className="relative w-full py-28 sm:py-40 px-6 sm:px-8 bg-[var(--bg-primary)]">
              ...
              >
                <div className="space-y-6 text-[var(--text-secondary)] text-lg leading-relaxed font-light">
                  <p>
                    ...
                    directed packaging for a Grammy Award–winning album, and directed a pilot with a
                    cast of fourteen.
                  </p>

                  <p className="text-[var(--text-primary)] text-xl sm:text-2xl font-serif italic leading-snug">
                  ...
                  <p>
                    ...
                    <a
                      ...
                      className="text-[var(--accent-gold)] hover:text-[var(--accent-copper)] underline underline-offset-2 transition-colors duration-300"
                    >
                      Signal to Noise
                    </a>.
                  </p>
                ...
                {/* Credentials - compact */}
                <div className="border border-[var(--border)] rounded-lg p-6 bg-[var(--bg-card)] warm-glow">
                  <h3 className="text-sm font-light tracking-widest uppercase text-[var(--accent-gold)] mb-5">
                    Music
                  </h3>

                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 text-[var(--text-secondary)] text-sm leading-relaxed font-light">
                    <div>
                      <p className="text-[var(--text-primary)] mb-1">Recording Academy</p>
                      <p>Voting member. The creative instincts that come from making music for 38 years inform everything I build for clients.</p>
                    </div>

                    <div>
                      <p className="text-[var(--text-primary)] mb-1">1,000+ Performances</p>
                      <p>Opened for Daughtry, KT Tunstall, Gin Blossoms, Boz Scaggs.</p>
                    </div>

                    <div>
                      <p className="text-[var(--text-primary)] mb-1">Releases</p>
