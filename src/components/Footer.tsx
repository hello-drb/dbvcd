...
export default function Footer() {
  ...
  return (
    <footer className="relative w-full py-16 px-6 sm:px-8 border-t border-[var(--border)] bg-[var(--bg-elevated)]">
            ...
            <ul className="space-y-3">
              <li>
                <a
                  ...
                  className="text-[var(--text-secondary)] hover:text-[var(--accent-gold)] transition-colors duration-300 font-light text-sm"
                >
                  DrewImages.Studio
                </a>
              </li>
